...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0b0e14] pb-20">
      {/* Header Compacto Mobile */}
      <header className="bg-[#0d1117] border-b border-gray-800 px-4 py-3 sticky top-0 z-30">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1.5 bg-blue-900/20 px-2 py-0.5 rounded border border-blue-800/50">
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar py-1">
          {MOCK_TICKERS.map(ticker => (
            <div key={ticker.symbol} className="bg-[#161b22] border border-gray-800 px-3 py-1.5 rounded flex items-center gap-2 min-w-fit shadow-sm">
      ...
      {/* Conteúdo Principal com Gestos/Fading */}
      <main className="flex-1 p-4">
        {activeTab === 'scanner' && (
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            {aiAnalysis && (
              <div className="animate-in slide-in-from-bottom-6 fade-in duration-500 relative group">
      ...
      {/* Bottom Navigation - Estilo Android */}
      <nav className="fixed bottom-0 left-0 right-0 bg-[#0d1117] border-t border-gray-800 safe-bottom z-50">
